...
class DataEncoder:
    def __init__(self):
        ...
        scale = 300.
        steps = [s / scale for s in (32, 64, 100, 300, 8, 16)]
        sizes = [s / scale for s in (111, 162, 213, 264, 315, 30, 60)]
        aspect_ratios = ((2,3), (2,3), (2,), (2,), (2,), (2,3))
        feature_map_sizes = (10, 5, 3, 1, 38, 19)
